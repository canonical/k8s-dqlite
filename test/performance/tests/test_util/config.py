...
DEFAULT_WAIT_RETRIES = int(os.getenv("TEST_DEFAULT_WAIT_RETRIES") or 100)
DEFAULT_WAIT_DELAY_S = int(os.getenv("TEST_DEFAULT_WAIT_DELAY_S") or 20)
...
OTEL_ENABLED = os.getenv("TEST_OTEL_ENABLED", "1") == "1"
