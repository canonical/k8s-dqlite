...
// RestoreToDqlite restores database contents from backup directory to a kine database.
...
// BackupEtcd makes a back up of the contents of a kine database into a filesystem directory.
